        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-200">
                ...
                <div class="px-8 py-6 border-b border-gray-100 bg-gray-50">
                    <h3 class="text-xl font-bold text-gray-800">Perbarui Kategori</h3>
                    <p class="text-sm text-gray-500 mt-1">Ubah nama atau jenis kategori.</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('categories.update', $category) }}" method="POST">
                        ...
                        @method('PUT') <div class="mb-6">
                            ...
                            <select name="type" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-5 text-gray-800 font-medium">
